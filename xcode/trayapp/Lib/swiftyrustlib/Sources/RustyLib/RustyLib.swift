...
public func applyDisplay(brightness: UInt8, red: UInt8, green: UInt8, blue: UInt8) -> Bool {
    return try! FfiConverterBool.lift(try! rustCall {
        uniffi_rustylib_fn_func_apply_display(
...
public func resetDisplay() -> Bool {
    return try! FfiConverterBool.lift(try! rustCall {
        uniffi_rustylib_fn_func_reset_display($0)
    })
}

public func startDisplayDaemon(brightness: UInt8, red: UInt8, green: UInt8, blue: UInt8) -> Bool {
    return try! FfiConverterBool.lift(try! rustCall {
        uniffi_rustylib_fn_func_start_display_daemon(
            FfiConverterUInt8.lower(brightness),
            FfiConverterUInt8.lower(red),
            FfiConverterUInt8.lower(green),
            FfiConverterUInt8.lower(blue), $0
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_rustylib_checksum_func_apply_display() != 65030 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_rustylib_checksum_func_reset_display() != 40645 {
        return InitializationResult.apiChecksumMismatch
    }
